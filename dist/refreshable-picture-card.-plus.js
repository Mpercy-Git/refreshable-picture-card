...
var hassObj = null;
class ResfeshablePictureCardPlus extends HTMLElement {
  ...
  set hass(hass) {
    ...
    try{
      ...
      console.log(err)
      console.log('waiting for refreshable-picture-card-plus to load');
    }
...
customElements.define('refreshable-picture-card-plus', ResfeshablePictureCardPlus);
